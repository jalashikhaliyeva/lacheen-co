...
function Hero() {
  ...
  const slides = [
    ...
    },
    {
      ...
      duration: 4500, // 4.5 seconds for video slide
      content: {
      ...
      >
        ...
        >
          ...
          {slides.map((slide, index) => {
            ...
            const isVideoSlide = index === 2;
            const isSaleSlide = index === 1;
            ...
            if (slide.type === "video") {
              return (
                ...
                >
                  ...
                  <div className="absolute inset-0 flex items-end justify-center p-4 text-center">
                    {/* <div className="max-w-2xl text-white font-gilroy text-center mb-8 transform transition-all duration-700 ease-in-out hover:scale-105">
