...
function CustomToast({ show, onClose, product, message, linkText, linkHref }) {
  ...
  return (
    <div 
      className={`fixed top-4 font-gilroy left-1/2 -translate-x-1/2 z-50 bg-white rounded-lg shadow-lg p-4 max-w-sm w-full transform transition-all duration-500 ease-in-out ${
